...
const BLIND_75_SEED = [
  { title: "Two Sum", topic: "Arrays", difficulty: "Easy", problemUrl: "https://leetcode.com/problems/two-sum/" },
  { title: "Valid Anagram", topic: "Strings", difficulty: "Easy", problemUrl: "https://leetcode.com/problems/valid-anagram/" },
  { title: "Group Anagrams", topic: "HashMaps", difficulty: "Medium", problemUrl: "https://leetcode.com/problems/group-anagrams/" },
  { title: "Top K Frequent Elements", topic: "Arrays", difficulty: "Medium", problemUrl: "https://leetcode.com/problems/top-k-frequent-elements/" },
  { title: "Product of Array Except Self", topic: "Arrays", difficulty: "Medium", problemUrl: "https://leetcode.com/problems/product-of-array-except-self/" }
];
...
exports.getDailyDeck = async (req, res) => {
  try {
    ...
    return res.status(200).json({ success: true, count: dailyDeck.length, data: dailyDeck });
  } catch (error) {
